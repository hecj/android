...
<html>
 ...
 <body class="easyui-layout">  
    ...
    <div id="west" region="west" split="true" title="West" style="width:150px;"></div>  
    <div id="center" region="center" class="easyui-tabs" style="padding:5px;background:#eee;">
...
<script type="text/javascript">
	...
	function open1(plugin,title){
		if ($('#center').tabs('exists',title)){
			...
			$('#center').tabs('add',{
				title:title,
				href:'http://www.jeasyui.com/documentation/welcome.php',
				closable:true
			});
