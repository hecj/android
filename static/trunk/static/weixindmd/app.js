...
var __imgHead__ = "";
var __wwwHead__ = "";
if (location.href.indexOf("http://red.duomeidai") == 0) {
	__env__ = "pro";
	__imgHead__ = 'http://static.duomeidai.com/weixindmd';
	__wwwHead__ = 'http://red.duomeidai.com';


} else if (location.href.indexOf("http://test.red.duomeidai") == 0) {
	__env__ = "test";
	__imgHead__ = "http://test.static.duomeidai.com/weixindmd";
	__wwwHead__ = 'http://test.red.duomeidai.com';
} else {
	__env__ = "dev";
	__imgHead__ = "http://dev.static.duomeidai.com/weixindmd";
	__wwwHead__ = 'http://dev.red.duomeidai.com';
...
angular.module("modules/project/templates/detail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/project/templates/detail.html",
    ...
    "                        <p class=\"rate\">\n" +
    "                            <i>\n" +
    "                              {{(entity.annualRate-entity.extendCarRate).toFixed(1)}}+{{entity.extendCarRate}}%\n" +
    "                            </i>\n" +
    "                        </p>\n" +
    "                    </div>\n" +
    "                    <p class=\"month\">\n" +
...
angular.module("modules/project/templates/invest.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/project/templates/invest.html",
    ...
    "                                {{(entity.annualRate/1).toFixed(1)}}%\n" +
    "                            </span>\n" +
    "                            <span ng-if=\"entity.productType==2||entity.productType==3\" style=\"font-size:13px\">\n" +
    "                                {{(entity.annualRate-entity.extendCarRate).toFixed(1)}}+{{entity.extendCarRate}}%\n" +
    "                            </span>\n" +
    "                        </p>\n" +
    "                        <p class=\"corgray\">\n" +
...
angular.module("modules/project/templates/list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/project/templates/list.html",
    ...
    "                              {{(item.annualRate-item.extendCarRate).toFixed(1)}}+{{item.extendCarRate}}%\n" +
    "                            </i>\n" +
    "                        </p>\n" +
    "                        </div>\n" +
    "                        <p class=\"month\">\n" +
