    ...
    var messageBox = function(msg) {
      $modal.open({
        ...
        controller: ['$scope', function(scop) {
          scop.title = msg;
          scop.message = "<div style='-webkit-overflow-scrolling: touch;overflow-y: scroll;'><iframe height='100%' width='100%' src='" + $scope.entity.loanAgreementURL + "' frameborder='0' allowfullscreen></iframe></div>";
  ...
  function($scope, $state, $stateParams, service, msgService, $modal) {
    ...
    var messageBox = function(msg) {
      $modal.open({
        ...
        controller: ['$scope', function(scop) {
          scop.title = msg;
          scop.message = "<div style='-webkit-overflow-scrolling: touch;overflow-y: scroll;'><iframe width='100%' height='300' src='" + $scope.entity.loanAgreementURL + "' frameborder='0' allowfullscreen></iframe></div>";
          scop.confirm = function() {
            scop.$close();
          }
        }]
  ...
  function($scope, $state, service, msgService, $modal) {
    ...
    var messageBox = function(msg, url) {
        $modal.open({
          ...
          controller: ['$scope', function(scop) {
            scop.title = msg;
            scop.message = "<div style='-webkit-overflow-scrolling: touch;overflow-y: scroll;'><iframe style='overflow-x : hidden; ' width='100%' height='300' src='" + url + "' frameborder='0' allowfullscreen></iframe></div>";
            scop.confirm = function() {
              scop.$close();
            }
          }]
...
angular.module("modules/project/templates/detail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/project/templates/detail.html",
    ...
    "                    <li ng-bind-html=\"entity.guaranteeAgency|safe\">\n" +
    ...
    "                    <li ng-bind-html=\"entity.valueAddedService|safe\">\n" +
    ...
    "                            还款日期\n" +
    "                        </th>\n" +
    "                        <th width=\"36%\" ng-if=\"!(entity.borrowStatus==3||entity.borrowStatus==5)\">\n" +
    "                            月还本息(元)\n" +
    "                        </th>\n" +
    "                        <th width=\"36%\" ng-if=\"entity.borrowStatus==3||entity.borrowStatus==5\">\n" +
    "                            还款金额(元)\n" +
    ...
    "                        </td>\n" +
    "                        <td>\n" +
    "                            <p class=\"corblue\" ng-if=\"!(entity.borrowStatus==3||entity.borrowStatus==5)\">\n" +
    "                                {{item.monPay}}\n" +
    "                            </p>\n" +
    "                            <p class=\"corblue\" ng-if=\"entity.borrowStatus==3||entity.borrowStatus==5\">\n" +
    ...
    "                        </td>\n" +
    "                        <td>\n" +
    "                            <p class=\"corred\" ng-if=\"!(entity.borrowStatus==3||entity.borrowStatus==5)\">\n" +
    "                                {{item.payRemain}}\n" +
    "                            </p>\n" +
    "                            <p class=\"corred\" ng-if=\"entity.borrowStatus==3||entity.borrowStatus==5\">\n" +
    "                                {{item.status}}\n" +
...
angular.module("modules/user/templates/bill.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/user/templates/bill.html",
    ...
    "                <span>结余：{{ (item.surplus/1).toFixed(2) }}元</span>\n" +
    "            </div>\n" +
    "        </li>\n" +
    "    </ul>\n" +
    "    <div class=\"all_more\">\n" +
...
angular.module("modules/user/templates/myproject.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/user/templates/myproject.html",
    ...
    "                        <p class=\"money\">{{ (item.bidAmount/1).toFixed(2) }}元</p>\n" +
    "                    </div>\n" +
    "                    <div class=\"jine_list\" ng-click=\"goDetail(item)\">\n" +
