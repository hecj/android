...
angular.module("modules/redenvelope/templates/friend.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/redenvelope/templates/friend.html",
    ...
    "	    	<img ng-if=\"partner.busImage!=''\" ng-src=\"{{partner.busImage}}\" width=\"256\" height=\"128\" />\n" +
    "		</div>\n" +
    "    </div>\n" +
    "    <div class=\"ad_gz\">\n" +
...
angular.module("modules/redenvelope/templates/jabme.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/redenvelope/templates/jabme.html",
    ...
    "            <li ng-class=\"{active:topflag==0}\" style=\"width:33.3%\"><a ng-click=\"topChange(0)\">我邀请的</a></li>\n" +
    "            <li ng-class=\"{active:topflag==1}\" style=\"width:33.3%\"><a ng-click=\"topChange(1)\">排行榜</a></li>\n" +
    "            <li ng-class=\"{active:topflag==2}\" style=\"width:33.3%\"><a ng-click=\"topChange(2)\">戳友同志</a></li>\n" +
    "        </ul>\n" +
    ...
    "              <li class=\"list-group-item lihg\" ng-class=\"{disabled:item.i_has_clicked=='true'}\" ng-repeat=\"item in invitelist\" ui-sref=\"redenvelope.friend({friendId: item.openId})\">\n" +
    "                  <div class=\"row\">\n" +
    "                      <div class=\"col-xs-6 col-sm-6 col-md-6 posit_bor\">\n" +
    "                        <img ng-if=\"item.is_auth=='true'&&item.is_receive!='true'\" src=\"http://dev.static.duomeidai.com/redenvelope/img/smrz.png\" width=\"15\" height=\"15\" style=\"margin-left:5px;\"/>\n" +
    "                        <img ng-if=\"item.is_reg=='true'&&item.is_receive!='true'&&item.is_auth!='true'\" src=\"http://dev.static.duomeidai.com/redenvelope/img/smzc.png\" width=\"15\" height=\"15\" style=\"margin-left:5px;\"/>\n" +
    "                        <img ng-if=\"item.is_receive=='true'\" src=\"http://dev.static.duomeidai.com/redenvelope/img/smsx.png\" width=\"15\" height=\"15\" style=\"margin-left:5px;\"/>\n" +
    "                        <div ng-if=\"!item.is_auth\" style=\"width:24px;height:20px;float: left;\"></div>\n" +
    ...
    "                      <div class=\"row\">\n" +
    "                          <div class=\"col-xs-12 col-sm-6 col-md-6 posit_bor\"><span>【{{item.nick|namefilter:8}}】</span></div>\n" +
    "                      </div>\n" +
    "                    </li>\n" +
