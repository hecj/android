 ...
 */
def html = FileUtils.readLines(new File("/Users/hecj/workspace/groovy/groovy/src/test20.html"));
...
dataList.add(eles.get(1).select("td").get(1).text());
	...
	dataList.add(eles.get(14).select("td").get(1).text());
        dataList.add(eles.get(15).select("td").get(1).text());
        dataList.add(eles.get(16).select("td").get(1).text());
	dataList.add(eles.get(17).select("td").get(1).text());
	dataList.add(eles.get(18).select("td").get(1).text());
	dataList.add(eles.get(19).select("td").get(1).text());
	dataList.add(eles.get(20).select("td").get(1).text());
	dataList.add(eles.get(22).select("td").get(1).text());
def row = 0;
 dataList.each {
	 println row+'---'+it;
	 row++;
